...
- [ansible/ansible](https://github.com/ansible/ansible) ([v2.16.3](https://github.com/ansible/ansible/releases/tag/v2.16.3), 1 day ago) - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy and maintain. Automate everything from code deployment to network configuration to cloud management, in a language that approaches plain English, using SSH, with no agents to install on remote systems. https://docs.ansible.com.
- [aws/karpenter-provider-aws](https://github.com/aws/karpenter-provider-aws) ([v0.32.6](https://github.com/aws/karpenter-provider-aws/releases/tag/v0.32.6), 4 days ago) - Karpenter is a Kubernetes Node Autoscaler built for flexibility, performance, and simplicity.
...
- [](https://pouet.chapril.org/@arthurzenika/111816583982118923) (5 days ago)
- [](https://pouet.chapril.org/@arthurzenika/111816574379263624) (5 days ago)

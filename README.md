...
- [Infisical/infisical](https://github.com/Infisical/infisical) ([v0.3.5](https://github.com/Infisical/infisical/releases/tag/v0.3.5), today) - ♾ Infisical is an open-source, end-to-end encrypted platform to sync secrets and configs across your team and infrastructure.
- [sigstore/cosign](https://github.com/sigstore/cosign) ([v2.0.0](https://github.com/sigstore/cosign/releases/tag/v2.0.0), 3 days ago) - Container Signing
- [scaleway/scaleway-cli](https://github.com/scaleway/scaleway-cli) ([v2.11.1](https://github.com/scaleway/scaleway-cli/releases/tag/v2.11.1), 5 days ago) - Command Line Interface for Scaleway
...
- [python-gitlab/python-gitlab](https://github.com/python-gitlab/python-gitlab) ([v3.13.0](https://github.com/python-gitlab/python-gitlab/releases/tag/v3.13.0), 4 weeks ago) - A python wrapper for the GitLab API.
...
- [À la découverte de Outscale – Cloud Public SecNumCloud](https://blog.zenika.com/2023/02/21/a-la-decouverte-de-outscale-cloud-public-secnumcloud/) (6 days ago)
...
- [](https://pouet.chapril.org/@arthurzenika/109913505847382868) (4 days ago)
- [](https://pouet.chapril.org/@arthurzenika/109901633573073500) (6 days ago)

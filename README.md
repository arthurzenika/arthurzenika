...
- [IBM/varnish-operator](https://github.com/IBM/varnish-operator) - Run and manage Varnish clusters on Kubernetes (today)
...
- [astraw/stdeb](https://github.com/astraw/stdeb) - produce Debian packages from Python packages (9 months ago)


#### 🔭 Latest releases I've contributed to

- [salesforce/sloop](https://github.com/salesforce/sloop) ([v1.0](https://github.com/salesforce/sloop/releases/tag/v1.0), today) - Kubernetes History Visualization
- [loft-sh/devspace](https://github.com/loft-sh/devspace) ([v5.14.1](https://github.com/loft-sh/devspace/releases/tag/v5.14.1), today) - DevSpace - The Fastest Developer Tool for Kubernetes ⚡ Automate your deployment workflow with DevSpace and develop software directly inside Kubernetes.
- [lensapp/lens](https://github.com/lensapp/lens) ([v5.0.0-beta.8](https://github.com/lensapp/lens/releases/tag/v5.0.0-beta.8), 4 days ago) - Lens - The Kubernetes IDE
...
- [arthurlutz: “☸️  Un opérateur Kubernetes po…”](https://social.logilab.org/@arthurlutz/106392968807200458) (4 days ago)
- [arthurlutz: “Atelier #BlueHats …”](https://social.logilab.org/@arthurlutz/106391498872523388) (4 days ago)

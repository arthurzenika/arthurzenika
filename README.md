...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.0.918](https://github.com/bridgecrewio/checkov/releases/tag/2.0.918), 1 day ago) - Prevent cloud misconfigurations during build-time for Terraform, CloudFormation, Kubernetes, Serverless framework and other infrastructure-as-code-languages with Checkov by Bridgecrew.
- [certbot/certbot](https://github.com/certbot/certbot) ([v1.24.0](https://github.com/certbot/certbot/releases/tag/v1.24.0), 4 days ago) - Certbot is EFF&#39;s tool to obtain certs from Let&#39;s Encrypt and (optionally) auto-enable HTTPS on your server.  It can also act as a client for any other CA that uses the ACME protocol.

...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.1.104](https://github.com/bridgecrewio/checkov/releases/tag/2.1.104), today) - Prevent cloud misconfigurations and find vulnerabilities during build-time in infrastructure as code, container images and open source packages with Checkov by Bridgecrew.

...
- [Infisical/infisical](https://github.com/Infisical/infisical) ([infisical-cli/v0.12.0](https://github.com/Infisical/infisical/releases/tag/infisical-cli/v0.12.0), today) - ♾ Infisical is an open-source, end-to-end encrypted platform for secret management: sync secrets across your team/infrastructure and prevent secret leaks.
...
- [](https://pouet.chapril.org/@arthurzenika/110904228135809879) (today)

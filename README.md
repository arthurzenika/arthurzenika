...
- [loft-sh/devspace](https://github.com/loft-sh/devspace) ([v5.15.0-beta.0](https://github.com/loft-sh/devspace/releases/tag/v5.15.0-beta.0), today) - DevSpace - The Fastest Developer Tool for Kubernetes ⚡ Automate your deployment workflow with DevSpace and develop software directly inside Kubernetes.

...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v3.3.12](https://github.com/argoproj/argo-cd/releases/tag/v3.3.12), 1 week ago) - Declarative Continuous Deployment for Kubernetes
- [postalserver/postal](https://github.com/postalserver/postal) ([3.3.7](https://github.com/postalserver/postal/releases/tag/3.3.7), 3 weeks ago) - 📮 A fully featured open source mail delivery platform for incoming &amp; outgoing e-mail
...
- [ent/ent](https://github.com/ent/ent) ([v0.14.6](https://github.com/ent/ent/releases/tag/v0.14.6), 3 months ago) - An entity framework for Go

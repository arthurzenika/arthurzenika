...
- [Infisical/infisical](https://github.com/Infisical/infisical) ([v0.2.22](https://github.com/Infisical/infisical/releases/tag/v0.2.22), today) - ♾ Infisical is an open-source, end-to-end encrypted tool to sync secrets and configs across your team and infrastructure.

...
- [lensapp/lens](https://github.com/lensapp/lens) ([v5.0.0-beta.10](https://github.com/lensapp/lens/releases/tag/v5.0.0-beta.10), 1 day ago) - Lens - The Kubernetes IDE
- [loft-sh/devspace](https://github.com/loft-sh/devspace) ([v5.14.2](https://github.com/loft-sh/devspace/releases/tag/v5.14.2), 6 days ago) - DevSpace - The Fastest Developer Tool for Kubernetes ⚡ Automate your deployment workflow with DevSpace and develop software directly inside Kubernetes.

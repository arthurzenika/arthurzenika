...
- [OneDeadKey/arsenik](https://github.com/OneDeadKey/arsenik) - A 33-key layout that works with all keyboards. (1 week ago)
...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v3.5.0](https://github.com/argoproj/argo-cd/releases/tag/v3.5.0), 6 days ago) - Declarative Continuous Deployment for Kubernetes

...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.1.91](https://github.com/bridgecrewio/checkov/releases/tag/2.1.91), today) - Prevent cloud misconfigurations and find vulnerabilities during build-time in infrastructure as code, container images and open source packages with Checkov by Bridgecrew.
- [python-gitlab/python-gitlab](https://github.com/python-gitlab/python-gitlab) ([v3.7.0](https://github.com/python-gitlab/python-gitlab/releases/tag/v3.7.0), 6 days ago) - A python wrapper for the GitLab API.
...
- [13 juil. 2022, 15:37](https://pouet.chapril.org/@arthurzenika/108640774184055036) (3 weeks ago)

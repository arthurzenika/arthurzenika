...
- [OneDeadKey/arsenik](https://github.com/OneDeadKey/arsenik) - A 33-key layout that works with all keyboards. (3 weeks ago)
...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v3.5.1](https://github.com/argoproj/argo-cd/releases/tag/v3.5.1), 1 week ago) - Declarative Continuous Deployment for Kubernetes

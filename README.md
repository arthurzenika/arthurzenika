...
- [Infisical/infisical](https://github.com/Infisical/infisical) ([v0.2.7](https://github.com/Infisical/infisical/releases/tag/v0.2.7), 3 days ago) - ♾ Infisical is an open-source, end-to-end encrypted tool to sync secrets and configs across your team and infrastructure.
- [scaleway/scaleway-cli](https://github.com/scaleway/scaleway-cli) ([v2.10.0](https://github.com/scaleway/scaleway-cli/releases/tag/v2.10.0), 4 days ago) - Command Line Interface for Scaleway
...
- [](https://pouet.chapril.org/@arthurzenika/109760761764412649) (1 day ago)

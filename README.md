...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.0.702](https://github.com/bridgecrewio/checkov/releases/tag/2.0.702), 1 day ago) - Prevent cloud misconfigurations during build-time for Terraform, Cloudformation, Kubernetes, Serverless framework and other infrastructure-as-code-languages with Checkov by Bridgecrew.
...
- [Chocobozzz/PeerTube](https://github.com/Chocobozzz/PeerTube) ([v4.0.0](https://github.com/Chocobozzz/PeerTube/releases/tag/v4.0.0), 3 weeks ago) - ActivityPub-federated video streaming platform using P2P directly in your web browser

...
- [SocialGouv/dashlord](https://github.com/SocialGouv/dashlord) - The best-practices Dashboard (today)
...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.0.935](https://github.com/bridgecrewio/checkov/releases/tag/2.0.935), today) - Prevent cloud misconfigurations during build-time for Terraform, CloudFormation, Kubernetes, Serverless framework and other infrastructure-as-code-languages with Checkov by Bridgecrew.
- [Chocobozzz/PeerTube](https://github.com/Chocobozzz/PeerTube) ([v4.1.1](https://github.com/Chocobozzz/PeerTube/releases/tag/v4.1.1), 2 days ago) - ActivityPub-federated video streaming platform using P2P directly in your web browser
...
- [arthurzenika: “🆕📰 Nouveau chapitre de ma vie …”](https://pouet.chapril.org/@arthurzenika/107925896841768962) (1 day ago)

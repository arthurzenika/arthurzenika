...
- [python-gitlab/python-gitlab](https://github.com/python-gitlab/python-gitlab) - A python wrapper for the GitLab API. (4 weeks ago)
...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.1.67](https://github.com/bridgecrewio/checkov/releases/tag/2.1.67), 1 day ago) - Prevent cloud misconfigurations and find vulnerabilities during build-time in infrastructure as code, container images and open source packages with Checkov by Bridgecrew.

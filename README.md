...
- [OneDeadKey/arsenik](https://github.com/OneDeadKey/arsenik) - A 33-key layout that works with all keyboards. (6 days ago)
...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v3.3.13](https://github.com/argoproj/argo-cd/releases/tag/v3.3.13), 4 days ago) - Declarative Continuous Deployment for Kubernetes

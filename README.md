...
- [loft-sh/devspace](https://github.com/loft-sh/devspace) ([v5.17.0-beta.1](https://github.com/loft-sh/devspace/releases/tag/v5.17.0-beta.1), today) - DevSpace - The Fastest Developer Tool for Kubernetes ⚡ Automate your deployment workflow with DevSpace and develop software directly inside Kubernetes.

...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.0.975](https://github.com/bridgecrewio/checkov/releases/tag/2.0.975), today) - Prevent cloud misconfigurations during build-time for Terraform, CloudFormation, Kubernetes, Serverless framework and other infrastructure-as-code-languages with Checkov by Bridgecrew.
- [certbot/certbot](https://github.com/certbot/certbot) ([v1.25.0](https://github.com/certbot/certbot/releases/tag/v1.25.0), 2 days ago) - Certbot is EFF&#39;s tool to obtain certs from Let&#39;s Encrypt and (optionally) auto-enable HTTPS on your server.  It can also act as a client for any other CA that uses the ACME protocol.
...
- [arthurzenika: “🐻  https://kuma.io/…”](https://pouet.chapril.org/@arthurzenika/107971044958060927) (1 day ago)
- [arthurzenika: “https://www.parca.dev/…”](https://pouet.chapril.org/@arthurzenika/107970984564159936) (1 day ago)
- [arthurzenika: “☸️ Outils découverts récemment…”](https://pouet.chapril.org/@arthurzenika/107965780097994327) (2 days ago)

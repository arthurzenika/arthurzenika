...
- [aws/karpenter](https://github.com/aws/karpenter) ([v0.31.0](https://github.com/aws/karpenter/releases/tag/v0.31.0), 1 day ago) - Karpenter is a Kubernetes Node Autoscaler built for flexibility, performance, and simplicity.
...
- [Infisical/infisical](https://github.com/Infisical/infisical) ([infisical-cli/v0.13.2](https://github.com/Infisical/infisical/releases/tag/infisical-cli/v0.13.2), 2 days ago) - ♾ Infisical is an open-source, end-to-end encrypted platform for secret management: sync secrets across your team/infrastructure and prevent secret leaks.
...
- [](https://pouet.chapril.org/@arthurzenika/111108565198711332) (6 days ago)

...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.1.98](https://github.com/bridgecrewio/checkov/releases/tag/2.1.98), 1 day ago) - Prevent cloud misconfigurations and find vulnerabilities during build-time in infrastructure as code, container images and open source packages with Checkov by Bridgecrew.
- [python-gitlab/python-gitlab](https://github.com/python-gitlab/python-gitlab) ([v3.8.0](https://github.com/python-gitlab/python-gitlab/releases/tag/v3.8.0), 2 days ago) - A python wrapper for the GitLab API.

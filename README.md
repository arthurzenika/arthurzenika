...
- [lensapp/lens](https://github.com/lensapp/lens) ([v5.3.0-alpha.6](https://github.com/lensapp/lens/releases/tag/v5.3.0-alpha.6), 1 day ago) - Lens - The Kubernetes IDE
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.0.524](https://github.com/bridgecrewio/checkov/releases/tag/2.0.524), 1 day ago) - Prevent cloud misconfigurations during build-time for Terraform, Cloudformation, Kubernetes, Serverless framework and other infrastructure-as-code-languages with Checkov by Bridgecrew.
- [loft-sh/devspace](https://github.com/loft-sh/devspace) ([v5.17.0-beta.6](https://github.com/loft-sh/devspace/releases/tag/v5.17.0-beta.6), 5 days ago) - DevSpace - The Fastest Developer Tool for Kubernetes ⚡ Automate your deployment workflow with DevSpace and develop software directly inside Kubernetes.

...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v3.4.5](https://github.com/argoproj/argo-cd/releases/tag/v3.4.5), today) - Declarative Continuous Deployment for Kubernetes

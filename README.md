...
- [Infisical/infisical](https://github.com/Infisical/infisical) ([v0.2.1](https://github.com/Infisical/infisical/releases/tag/v0.2.1), today) - ♾ Infisical is an open-source, end-to-end encrypted tool to sync environment variables across your team and infrastructure.

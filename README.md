...
- [aws/karpenter-provider-aws](https://github.com/aws/karpenter-provider-aws) ([v0.34.0](https://github.com/aws/karpenter-provider-aws/releases/tag/v0.34.0), today) - Karpenter is a Kubernetes Node Autoscaler built for flexibility, performance, and simplicity.
...
- [](https://pouet.chapril.org/@arthurzenika/111885610940820121) (today)

...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.0.929](https://github.com/bridgecrewio/checkov/releases/tag/2.0.929), today) - Prevent cloud misconfigurations during build-time for Terraform, CloudFormation, Kubernetes, Serverless framework and other infrastructure-as-code-languages with Checkov by Bridgecrew.
- [Chocobozzz/PeerTube](https://github.com/Chocobozzz/PeerTube) ([v4.1.1](https://github.com/Chocobozzz/PeerTube/releases/tag/v4.1.1), 1 day ago) - ActivityPub-federated video streaming platform using P2P directly in your web browser

...
- [kubefirst/kubefirst](https://github.com/kubefirst/kubefirst) ([v2.3.3](https://github.com/kubefirst/kubefirst/releases/tag/v2.3.3), 3 days ago) - The Kubefirst Open Source Platform
- [HewlettPackard/oneview-python](https://github.com/HewlettPackard/oneview-python) ([v8.6.0](https://github.com/HewlettPackard/oneview-python/releases/tag/v8.6.0), 6 days ago) - Python library for HPE OneView
...
- [ansible/ansible](https://github.com/ansible/ansible) ([v2.16.0rc1](https://github.com/ansible/ansible/releases/tag/v2.16.0rc1), 2 weeks ago) - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy and maintain. Automate everything from code deployment to network configuration to cloud management, in a language that approaches plain English, using SSH, with no agents to install on remote systems. https://docs.ansible.com.
...
- [](https://pouet.chapril.org/@arthurzenika/111301713679609248) (4 days ago)
- [](https://pouet.chapril.org/@arthurzenika/111301692521162078) (4 days ago)

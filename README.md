...
- [stephrobert/awesome-french-devops](https://github.com/stephrobert/awesome-french-devops) - Une liste de liens permettant de se former aux outils utilisés dans le domaine du Devops (1 day ago)
...
- [python-gitlab/python-gitlab](https://github.com/python-gitlab/python-gitlab) ([v3.10.0](https://github.com/python-gitlab/python-gitlab/releases/tag/v3.10.0), 6 days ago) - A python wrapper for the GitLab API.
...
- [27 sept. 2022, 14:44](https://pouet.chapril.org/@arthurzenika/109070900318066510) (1 week ago)

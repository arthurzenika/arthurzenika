...
- [ansible/ansible](https://github.com/ansible/ansible) ([v2.14.14rc1](https://github.com/ansible/ansible/releases/tag/v2.14.14rc1), 2 days ago) - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy and maintain. Automate everything from code deployment to network configuration to cloud management, in a language that approaches plain English, using SSH, with no agents to install on remote systems. https://docs.ansible.com.
...
- [](https://pouet.chapril.org/@arthurzenika/111805362031586001) (1 day ago)

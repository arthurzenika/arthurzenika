...
- [OneDeadKey/arsenik](https://github.com/OneDeadKey/arsenik) - A 33-key layout that works with all keyboards. (2 days ago)
...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v3.5.0-rc3](https://github.com/argoproj/argo-cd/releases/tag/v3.5.0-rc3), 3 days ago) - Declarative Continuous Deployment for Kubernetes

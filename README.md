...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v3.5.0](https://github.com/argoproj/argo-cd/releases/tag/v3.5.0), today) - Declarative Continuous Deployment for Kubernetes

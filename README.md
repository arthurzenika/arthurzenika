...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v3.5.0-rc2](https://github.com/argoproj/argo-cd/releases/tag/v3.5.0-rc2), 1 day ago) - Declarative Continuous Deployment for Kubernetes
- [postalserver/postal](https://github.com/postalserver/postal) ([3.3.7](https://github.com/postalserver/postal/releases/tag/3.3.7), 4 weeks ago) - 📮 A fully featured open source mail delivery platform for incoming &amp; outgoing e-mail

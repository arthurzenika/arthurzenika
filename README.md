...
- [ansible/ansible](https://github.com/ansible/ansible) ([v2.16.5rc1](https://github.com/ansible/ansible/releases/tag/v2.16.5rc1), 1 day ago) - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy and maintain. Automate everything from code deployment to network configuration to cloud management, in a language that approaches plain English, using SSH, with no agents to install on remote systems. https://docs.ansible.com.
- [kubefirst/kubefirst](https://github.com/kubefirst/kubefirst) ([v2.4.2](https://github.com/kubefirst/kubefirst/releases/tag/v2.4.2), 1 day ago) - The Kubefirst Open Source Platform
...
- [aws/karpenter-provider-aws](https://github.com/aws/karpenter-provider-aws) ([v0.34.3](https://github.com/aws/karpenter-provider-aws/releases/tag/v0.34.3), 5 days ago) - Karpenter is a Kubernetes Node Autoscaler built for flexibility, performance, and simplicity.
...
- [](https://pouet.chapril.org/@arthurzenika/112117180994593548) (1 day ago)
- [](https://pouet.chapril.org/@arthurzenika/112088428182653689) (6 days ago)
- [](https://pouet.chapril.org/@arthurzenika/112088423083607597) (6 days ago)

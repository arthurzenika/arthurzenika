...
- [lensapp/lens](https://github.com/lensapp/lens) ([v4.2.0-rc.1](https://github.com/lensapp/lens/releases/tag/v4.2.0-rc.1), today) - Lens - The Kubernetes IDE
- [loft-sh/devspace](https://github.com/loft-sh/devspace) ([v5.9.1](https://github.com/loft-sh/devspace/releases/tag/v5.9.1), today) - DevSpace - The Fastest Developer Tool for Kubernetes ⚡ Automate your deployment workflow with DevSpace and develop software directly inside Kubernetes.

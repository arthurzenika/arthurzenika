...
- [arthurlogilab/jupyterlite](https://github.com/arthurlogilab/jupyterlite) -  (1 day ago)
...
- [lensapp/lens](https://github.com/lensapp/lens) ([v5.1.0](https://github.com/lensapp/lens/releases/tag/v5.1.0), 1 day ago) - Lens - The Kubernetes IDE
- [loft-sh/devspace](https://github.com/loft-sh/devspace) ([v5.14.4-beta.1](https://github.com/loft-sh/devspace/releases/tag/v5.14.4-beta.1), 1 day ago) - DevSpace - The Fastest Developer Tool for Kubernetes ⚡ Automate your deployment workflow with DevSpace and develop software directly inside Kubernetes.

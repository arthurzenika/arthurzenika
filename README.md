...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.1.12](https://github.com/bridgecrewio/checkov/releases/tag/2.1.12), today) - Prevent cloud misconfigurations and find vulnerabilities during build-time in infrastructure as code, container images and open source packages with Checkov by Bridgecrew.

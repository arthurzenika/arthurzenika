...
- [aws/karpenter](https://github.com/aws/karpenter) ([v0.27.8](https://github.com/aws/karpenter/releases/tag/v0.27.8), 1 day ago) - Karpenter is a Kubernetes Node Autoscaler built for flexibility, performance, and simplicity.
...
- [sigstore/cosign](https://github.com/sigstore/cosign) ([v2.2.1](https://github.com/sigstore/cosign/releases/tag/v2.2.1), 4 days ago) - Container Signing
- [ansible/ansible](https://github.com/ansible/ansible) ([v2.16.0](https://github.com/ansible/ansible/releases/tag/v2.16.0), 5 days ago) - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy and maintain. Automate everything from code deployment to network configuration to cloud management, in a language that approaches plain English, using SSH, with no agents to install on remote systems. https://docs.ansible.com.
...
- [](https://pouet.chapril.org/@arthurzenika/111375675180868648) (3 days ago)
- [](https://pouet.chapril.org/@arthurzenika/111375650827507762) (3 days ago)
- [](https://pouet.chapril.org/@arthurzenika/111369170001344221) (4 days ago)
- [](https://pouet.chapril.org/@arthurzenika/111369161441331157) (4 days ago)
- [](https://pouet.chapril.org/@arthurzenika/111369153796218981) (4 days ago)

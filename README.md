...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.0.666](https://github.com/bridgecrewio/checkov/releases/tag/2.0.666), today) - Prevent cloud misconfigurations during build-time for Terraform, Cloudformation, Kubernetes, Serverless framework and other infrastructure-as-code-languages with Checkov by Bridgecrew.

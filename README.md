...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.0.956](https://github.com/bridgecrewio/checkov/releases/tag/2.0.956), today) - Prevent cloud misconfigurations during build-time for Terraform, CloudFormation, Kubernetes, Serverless framework and other infrastructure-as-code-languages with Checkov by Bridgecrew.

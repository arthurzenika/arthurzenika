...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.0.581](https://github.com/bridgecrewio/checkov/releases/tag/2.0.581), today) - Prevent cloud misconfigurations during build-time for Terraform, Cloudformation, Kubernetes, Serverless framework and other infrastructure-as-code-languages with Checkov by Bridgecrew.
- [lensapp/lens](https://github.com/lensapp/lens) ([v5.3.0-beta.0](https://github.com/lensapp/lens/releases/tag/v5.3.0-beta.0), today) - Lens - The Kubernetes IDE

...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.1.94](https://github.com/bridgecrewio/checkov/releases/tag/2.1.94), today) - Prevent cloud misconfigurations and find vulnerabilities during build-time in infrastructure as code, container images and open source packages with Checkov by Bridgecrew.
- [python-gitlab/python-gitlab](https://github.com/python-gitlab/python-gitlab) ([v3.7.0](https://github.com/python-gitlab/python-gitlab/releases/tag/v3.7.0), 1 week ago) - A python wrapper for the GitLab API.

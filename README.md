...
- [scaleway/scaleway-cli](https://github.com/scaleway/scaleway-cli) ([v2.16.0](https://github.com/scaleway/scaleway-cli/releases/tag/v2.16.0), 3 days ago) - Command Line Interface for Scaleway
- [python-gitlab/python-gitlab](https://github.com/python-gitlab/python-gitlab) ([v3.15.0](https://github.com/python-gitlab/python-gitlab/releases/tag/v3.15.0), 3 days ago) - A python wrapper for the GitLab API.
- [FairwindsOps/goldilocks](https://github.com/FairwindsOps/goldilocks) ([v4.8.3](https://github.com/FairwindsOps/goldilocks/releases/tag/v4.8.3), 6 days ago) - Get your resource requests &#34;Just Right&#34;

...
- [loft-sh/devspace](https://github.com/loft-sh/devspace) ([v5.16.1](https://github.com/loft-sh/devspace/releases/tag/v5.16.1), today) - DevSpace - The Fastest Developer Tool for Kubernetes ⚡ Automate your deployment workflow with DevSpace and develop software directly inside Kubernetes.
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.0.474](https://github.com/bridgecrewio/checkov/releases/tag/2.0.474), today) - Prevent cloud misconfigurations during build-time for Terraform, Cloudformation, Kubernetes, Serverless framework and other infrastructure-as-code-languages with Checkov by Bridgecrew.

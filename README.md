...
- [sigstore/cosign](https://github.com/sigstore/cosign) ([v1.13.2](https://github.com/sigstore/cosign/releases/tag/v1.13.2), 3 days ago) - Container Signing
- [aws/karpenter](https://github.com/aws/karpenter) ([v0.31.3](https://github.com/aws/karpenter/releases/tag/v0.31.3), 4 days ago) - Karpenter is a Kubernetes Node Autoscaler built for flexibility, performance, and simplicity.

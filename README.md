...
- [lensapp/lens](https://github.com/lensapp/lens) ([v4.1.0-alpha.2](https://github.com/lensapp/lens/releases/tag/v4.1.0-alpha.2), today) - Lens - The Kubernetes IDE
- [vector-im/element-web](https://github.com/vector-im/element-web) ([v1.7.19](https://github.com/vector-im/element-web/releases/tag/v1.7.19), today) - A glossy Matrix collaboration client for the web.

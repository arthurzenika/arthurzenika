...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.0.1183](https://github.com/bridgecrewio/checkov/releases/tag/2.0.1183), today) - Prevent cloud misconfigurations and find vulnerabilities during build-time in infrastructure as code, container images and open source packages with Checkov by Bridgecrew.

...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.0.549](https://github.com/bridgecrewio/checkov/releases/tag/2.0.549), 1 day ago) - Prevent cloud misconfigurations during build-time for Terraform, Cloudformation, Kubernetes, Serverless framework and other infrastructure-as-code-languages with Checkov by Bridgecrew.
- [lensapp/lens](https://github.com/lensapp/lens) ([v5.3.0-alpha.9](https://github.com/lensapp/lens/releases/tag/v5.3.0-alpha.9), 2 days ago) - Lens - The Kubernetes IDE
- [certbot/certbot](https://github.com/certbot/certbot) ([v1.21.0](https://github.com/certbot/certbot/releases/tag/v1.21.0), 2 days ago) - Certbot is EFF&#39;s tool to obtain certs from Let&#39;s Encrypt and (optionally) auto-enable HTTPS on your server.  It can also act as a client for any other CA that uses the ACME protocol.
...
- [arthurlutz: “Mercredi prochain à Paris, nou…”](https://social.logilab.org/@arthurlutz/107225092816336760) (1 day ago)
- [arthurlutz: “Mardi prochain à Paris, venez …”](https://social.logilab.org/@arthurlutz/107224985873850766) (1 day ago)

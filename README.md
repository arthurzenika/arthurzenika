...
- [scaleway/scaleway-cli](https://github.com/scaleway/scaleway-cli) ([v2.10.0](https://github.com/scaleway/scaleway-cli/releases/tag/v2.10.0), 1 day ago) - Command Line Interface for Scaleway
- [Infisical/infisical](https://github.com/Infisical/infisical) ([v0.2.6](https://github.com/Infisical/infisical/releases/tag/v0.2.6), 1 day ago) - ♾ Infisical is an open-source, end-to-end encrypted tool to sync secrets and configs across your team and infrastructure.
...
- [](https://pouet.chapril.org/@arthurzenika/109721759030800122) (5 days ago)

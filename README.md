...
- [sigstore/cosign](https://github.com/sigstore/cosign) ([v2.2.3](https://github.com/sigstore/cosign/releases/tag/v2.2.3), 4 days ago) - Code signing and transparency for containers and binaries
- [aws/karpenter-provider-aws](https://github.com/aws/karpenter-provider-aws) ([v0.33.2](https://github.com/aws/karpenter-provider-aws/releases/tag/v0.33.2), 5 days ago) - Karpenter is a Kubernetes Node Autoscaler built for flexibility, performance, and simplicity.
- [ansible/ansible](https://github.com/ansible/ansible) ([v2.16.3](https://github.com/ansible/ansible/releases/tag/v2.16.3), 6 days ago) - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy and maintain. Automate everything from code deployment to network configuration to cloud management, in a language that approaches plain English, using SSH, with no agents to install on remote systems. https://docs.ansible.com.
...
- [](https://pouet.chapril.org/@arthurzenika/111873728155138754) (today)
- [](https://pouet.chapril.org/@arthurzenika/111873722262474762) (today)
- [](https://pouet.chapril.org/@arthurzenika/111873596720365624) (today)
- [](https://pouet.chapril.org/@arthurzenika/111873587509042297) (today)
- [](https://pouet.chapril.org/@arthurzenika/111873520313588110) (today)

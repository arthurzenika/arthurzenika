...
- [IBM/varnish-operator](https://github.com/IBM/varnish-operator) - Run and manage Varnish clusters on Kubernetes (3 days ago)
...
- [loft-sh/devspace](https://github.com/loft-sh/devspace) ([v5.14.2](https://github.com/loft-sh/devspace/releases/tag/v5.14.2), 1 day ago) - DevSpace - The Fastest Developer Tool for Kubernetes ⚡ Automate your deployment workflow with DevSpace and develop software directly inside Kubernetes.
- [lensapp/lens](https://github.com/lensapp/lens) ([v5.0.0-beta.9](https://github.com/lensapp/lens/releases/tag/v5.0.0-beta.9), 1 day ago) - Lens - The Kubernetes IDE
- [salesforce/sloop](https://github.com/salesforce/sloop) ([v1.0](https://github.com/salesforce/sloop/releases/tag/v1.0), 3 days ago) - Kubernetes History Visualization

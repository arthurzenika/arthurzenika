...
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) ([2.0.446](https://github.com/bridgecrewio/checkov/releases/tag/2.0.446), 1 day ago) - Prevent cloud misconfigurations during build-time for Terraform, Cloudformation, Kubernetes, Serverless framework and other infrastructure-as-code-languages with Checkov by Bridgecrew.
- [lensapp/lens](https://github.com/lensapp/lens) ([v5.2.4](https://github.com/lensapp/lens/releases/tag/v5.2.4), 5 days ago) - Lens - The Kubernetes IDE
- [loft-sh/devspace](https://github.com/loft-sh/devspace) ([v5.16.0](https://github.com/loft-sh/devspace/releases/tag/v5.16.0), 5 days ago) - DevSpace - The Fastest Developer Tool for Kubernetes ⚡ Automate your deployment workflow with DevSpace and develop software directly inside Kubernetes.

...
- [aws/karpenter](https://github.com/aws/karpenter) ([v0.30.0-rc.0](https://github.com/aws/karpenter/releases/tag/v0.30.0-rc.0), today) - Karpenter is a Kubernetes Node Autoscaler built for flexibility, performance, and simplicity.
